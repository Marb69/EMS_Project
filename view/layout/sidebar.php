    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar__nav">
            ...
            <div class="nav-section">
                ...
                <a href="index.php?page=admin&section=overview" class="nav-item <?= $current_page === 'dashboard' ? 'active' : '' ?>">
            ...
            <div class="nav-section">
                ...
                <a href="index.php?page=admin&section=employees" class="nav-item <?= $current_page === 'employees' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="index.php?page=admin&section=departments" class="nav-item <?= $current_page === 'departments' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
