...
<div class="ems-stats">
  ...
  <div class="ems-sc ems-sc--blue">
    ...
    <div class="ems-sc__value" data-ems-count="<?=$total ?>">0</div>
  ...
  <div class="ems-sc ems-sc--green">
    ...
    <div class="ems-sc__value" data-ems-count="<?= $present?>">0</div>
    <div class="ems-sc__sub">
      <span class="ems-sc__badge ems-bdg--up"><?= $rate ?>%</span>
      attendance rate
    </div>
  </div>
  ...
  <div class="ems-sc ems-sc--amber">
    ...
    <div class="ems-sc__value" data-ems-count="<?= $Onleave ?>">0</div>
    <div class="ems-sc__sub">
      <span class="ems-sc__badge ems-bdg--warn">5 pending</span>
      approval
    </div>
  </div>
  ...
  <div class="ems-sc ems-sc--danger">
    ...
    <div class="ems-sc__value" data-ems-count="<?= $absent?>">0</div>
    <div class="ems-sc__sub">
